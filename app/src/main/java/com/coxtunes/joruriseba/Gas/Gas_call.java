package com.coxtunes.joruriseba.Gas;
...
public class Gas_call extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater,  ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.gas_call, container, false);
    ...
    public void contactLoad(){
        String serverUrl = getString(R.string.server_url)+"contacts/read.php?table=gas";
